        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          >
            <Link to="/" className="flex items-center gap-3 mb-12">
              ...
              <span className="text-2xl font-bold text-foreground">SmartAudit</span>
            </Link>
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-md">
              Automate your invoice processing with advanced AI technology. 
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-foreground">Process 1000+ invoices daily</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center">
                  <span className="text-primary">✓</span>
                </div>
                <span className="text-foreground">Real-time fraud detection</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <Link to="/" className="flex items-center gap-3 mb-8 lg:hidden">
            ...
            <span className="text-xl font-bold text-foreground">SmartAudit</span>
          </Link>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  className="pl-10 pr-10 bg-card border-border/50 focus:border-primary h-12"
                />
                <button
                  type="button"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <Button 
                type="button" 
                variant="outline" 
                className="h-12 border-border/50 bg-card hover:bg-card/80"
